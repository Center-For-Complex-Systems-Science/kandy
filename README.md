...
solve_scalar(u0, dx, n_steps, dt, flux_fn, speed_fn, roe_speed_fn=None,
             scheme='rusanov', limiter='minmod', time_stepper='tvdrk2', save_every=1)
fv_rhs(u, dx, flux_fn, speed_fn, roe_speed_fn=None, scheme='rusanov', limiter='minmod')
...
order_param_torch(theta)            # Kuramoto order parameter |⟨eⁱᶿ⟩|
