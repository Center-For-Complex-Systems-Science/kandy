...
fig.tight_layout()
save_fig(fig, "cfc_v3_soz_channels")
...
fig.tight_layout()
save_fig(fig, "cfc_v3_full_array")
...
axes[-1, 1].set_xlabel("Time (s)")
fig.tight_layout()
save_fig(fig, "cfc_v3_seizure_zoom")
...
fig.tight_layout()
save_fig(fig, "cfc_v3_spectrogram")
...
fig.tight_layout()
save_fig(fig, "cfc_v3_pac_visualization")
